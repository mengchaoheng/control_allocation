###########################################################################
## Makefile generated for MATLAB file/project 'dyn_alloc_m'. 
## 
## Makefile     : dyn_alloc_m_rtw.mk
## Generated on : Tue Aug 18 19:12:30 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dyn_alloc_m.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/control_program/控制分配matlab转C工程/双涵道
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dyn_alloc_m.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=512 -DMODEL=dyn_alloc_m -DHAVESTDIO -DUSE_RTMODEL
DEFINES_SKIPFORSIL = -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=512
DEFINES_STANDARD = -DMODEL=dyn_alloc_m -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/dyn_alloc_m/dyn_alloc_m.c
...
%.o : $(START_DIR)/codegen/lib/dyn_alloc_m/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/dyn_alloc_m/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/dyn_alloc_m/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/dyn_alloc_m/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/dyn_alloc_m/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
