/*
 * File: _coder_dir_alloc_mch_api.c
 *
...
#include "_coder_dir_alloc_mch_mex.h"
...
static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *umin,
  ...
  const char_T *identifier))[4]
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(umin), &thisId);
 ...
 * Return Type  : void
 */
  void dir_alloc_mch_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*u)[4];
  real_T (*v)[3];
  ...
  umin = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "umin");
  umax = c_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "umax");

  /* Invoke the target function */
  dir_alloc_mch(*v, *umin, *umax, *u);
 ...
 * Return Type  : void
 */
void dir_alloc_mch_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_dir_alloc_mch_api.c
 *
 * [EOF]
 */
