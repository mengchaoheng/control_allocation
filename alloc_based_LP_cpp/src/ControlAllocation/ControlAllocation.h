...
public:
    ...
    float* DPscaled_LPCA(float input[ControlSize]){
        // Direction Preserving Control Allocation Linear Program
    ...
    LinearProgrammingSolverForAC<ControlSize, EffectorSize+1> LPsolverForAC; // test the running time
