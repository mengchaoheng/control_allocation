...
static void main_wls_alloc_m(void);
...
static void main_wls_alloc_m(void)
{
  ...
  /* Initialize function 'wls_alloc_m' input arguments. */
  ...
  /* Call the entry-point 'wls_alloc_m'. */
  argInit_1x2_real_T(dv0);
  argInit_1x2_real_T(dv1);
  argInit_3x3_real_T(dv2);
  argInit_9x9_real_T(dv3);
  argInit_9x1_real_T(dv4);
  wls_alloc_m(B, v, u, dv0, dv1, argInit_real_T(), dv2, dv3, dv4, argInit_real_T
