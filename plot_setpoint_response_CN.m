...
ulgFileName = '10_27_37'; % the ulog file name. load 06_28_53 06_45_38  06_54_35 wind 11_39_14  15_57_58 wp:17_09_30, endurance:17_14_37 (18.9) 06_26_32 (17.8) 06_50_20 (19.6) (19.5) 07_10_30 (18.6)
tmp=[ ulgFileName '.mat'];
% exist tmp var
if exist(tmp,"file")
...
plot((vehicle_angular_velocity(:,1)-vehicle_rates_setpoint(1,1))*1e-6, vehicle_angular_velocity(:,3)*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
...
plot((vehicle_angular_velocity(:,1)-vehicle_rates_setpoint(1,1))*1e-6, vehicle_angular_velocity(:,4)*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([-inf inf -100 100]);
xlabel({'时间(s)'});
ylabel('俯仰(deg/s)')
...
plot((vehicle_angular_velocity(:,1)-vehicle_rates_setpoint(1,1))*1e-6, vehicle_angular_velocity(:,5)*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([-inf inf -100 100]);
xlabel({'时间(s)'});
ylabel('偏航(deg/s)')
...
plot((vehicle_attitude(:,1)-vehicle_attitude_setpoint(1,1))*1e-6, Roll*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([-inf inf -100 100]);
xlabel({'时间(s)'});
ylabel('滚转角(deg)')
...
plot((vehicle_attitude(:,1)-vehicle_attitude_setpoint(1,1))*1e-6, Pitch*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([-inf inf -100 100]);
xlabel({'时间(s)'});
ylabel('俯仰角(deg)')
...
plot((vehicle_attitude(:,1)-vehicle_attitude_setpoint(1,1))*1e-6, Yaw*r2d,'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([-inf inf -100 100]);
xlabel({'时间(s)'});
ylabel('偏航角(deg)')
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, V_XYZ(:,1),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
title('速度');
xlabel({'时间(s)'});
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, V_XYZ(:,2),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
xlabel({'时间(s)'});
ylabel('V_Y(m/s)')
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, V_XYZ(:,3),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
xlabel({'时间(s)'});
ylabel('V_Z(m/s)')
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, XYZ(:,1),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
title('位置');
xlabel({'时间(s)'});
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, XYZ(:,2),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
xlabel({'时间(s)'});
ylabel('Y(m)')
...
plot((vehicle_local_position(:,1)-vehicle_local_position_setpoint(1,1))*1e-6, XYZ(:,3),'--','LineWidth',1,'color',[0.6,0.2,0]);hold on;
grid on;
% axis([0 1200 -inf inf]);
xlabel({'时间(s)'});
ylabel('Z(m)')
...
% fig7=figure(7);
% subplot(411)
% plot((actuator_controls(:,1)-actuator_controls(1,1))*1e-6, Roll_control(:,1)-indi_feedback_input(:,3),'r-','LineWidth',1);hold on;
% plot((actuator_controls(:,1))*1e-6, Pitch_control(:,1)-indi_feedback_input(:,4),'k--','LineWidth',1);hold on;
...
% ylabel('滚转')
% subplot(413)
% plot((actuator_controls(:,1)-actuator_controls(1,1))*1e-6, Pitch_control(:,1)-indi_feedback_input(:,4),'k--','LineWidth',1);hold on;
% grid on;
% axis([-inf inf -0.5 0.5]);
% xlabel({'时间(s)'});
% ylabel('俯仰')
% subplot(414)
% plot((actuator_controls(:,1)-actuator_controls(1,1))*1e-6, Yaw_control(:,1)-indi_feedback_input(:,5),'b-.','LineWidth',1);hold on;
% grid on;
% axis([-inf inf -0.5 0.5]);
% xlabel({'时间(s)'});
% ylabel('偏航')
