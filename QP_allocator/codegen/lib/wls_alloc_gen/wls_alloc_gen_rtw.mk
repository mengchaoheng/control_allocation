###########################################################################
## Makefile generated for component 'wls_alloc_gen'. 
## 
## Makefile     : wls_alloc_gen_rtw.mk
## Generated on : Mon Jun 16 11:03:39 2025
## Final product: ./wls_alloc_gen.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/wls_alloc_gen -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=wls_alloc_gen
...
SRCS = $(START_DIR)/codegen/lib/wls_alloc_gen/wls_alloc_gen.c $(START_DIR)/codegen/lib/wls_alloc_gen/wls_alloc_gen_emxutil.c
...
OBJS = wls_alloc_gen.o wls_alloc_gen_emxutil.o
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_gen/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/wls_alloc_gen/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/wls_alloc_gen/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_gen/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_gen/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
wls_alloc_gen.o : $(START_DIR)/codegen/lib/wls_alloc_gen/wls_alloc_gen.c
	$(CC) $(CFLAGS) -o "$@" "$<"


wls_alloc_gen_emxutil.o : $(START_DIR)/codegen/lib/wls_alloc_gen/wls_alloc_gen_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"
