###########################################################################
## Makefile generated for MATLAB file/project 'dir_alloc_mch'. 
## 
## Makefile     : dir_alloc_mch_rtw.mk
## Generated on : Sun Nov 24 20:09:15 2019
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dir_alloc_mch.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/mengc/Desktop/¿ØÖÆ·Ö~1/LINEAR~1
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dir_alloc_mch.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=dir_alloc_mch -DHAVESTDIO -DUSE_RTMODEL
...
DEFINES_STANDARD = -DMODEL=dir_alloc_mch -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/dir_alloc_mch/dir_alloc_mch.c
...
%.o : $(START_DIR)/codegen/lib/dir_alloc_mch/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/dir_alloc_mch/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/dir_alloc_mch/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/dir_alloc_mch/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/dir_alloc_mch/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
