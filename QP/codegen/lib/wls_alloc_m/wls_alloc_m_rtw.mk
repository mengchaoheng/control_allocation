###########################################################################
## Makefile generated for MATLAB file/project 'wls_alloc_m'. 
## 
## Makefile     : wls_alloc_m_rtw.mk
## Generated on : Tue Aug 18 19:20:06 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/wls_alloc_m.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/wls_alloc_m.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=512 -DMODEL=wls_alloc_m -DHAVESTDIO -DUSE_RTMODEL
...
DEFINES_STANDARD = -DMODEL=wls_alloc_m -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/wls_alloc_m/wls_alloc_m.c
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_m/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/wls_alloc_m/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_m/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/wls_alloc_m/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/wls_alloc_m/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
