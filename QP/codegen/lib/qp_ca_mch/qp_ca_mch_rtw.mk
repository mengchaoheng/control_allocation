###########################################################################
## Makefile generated for MATLAB file/project 'qp_ca_mch'. 
## 
## Makefile     : qp_ca_mch_rtw.mk
## Generated on : Mon Aug 17 18:50:02 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/qp_ca_mch.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/qp_ca_mch.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=qp_ca_mch -DHAVESTDIO -DUSE_RTMODEL
...
DEFINES_STANDARD = -DMODEL=qp_ca_mch -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/qp_ca_mch/qp_ca_mch.c
...
%.o : $(START_DIR)/codegen/lib/qp_ca_mch/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/qp_ca_mch/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/qp_ca_mch/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/codegen/lib/qp_ca_mch/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/codegen/lib/qp_ca_mch/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
